...
Progressbar::Progressbar(int max) : max(static_cast<float>(max)), progress(0)
{
...
void Progressbar::update() { this->progress++; }

void Progressbar::update(int prog) { this->progress += prog; }
